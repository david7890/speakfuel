...
export default function DashboardLayout({
  ...
  const isJuegoParejas = pathname.includes('/juego-parejas');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      {!isLessonPage && !isPalabrasFrecuentesPage && !isJuegoParejas && (
        <DashboardNav 
      ...
      <main className={isLessonPage || isPalabrasFrecuentesPage || isJuegoParejas ? '' : 'pt-16'}>
        {children}
      </main>
