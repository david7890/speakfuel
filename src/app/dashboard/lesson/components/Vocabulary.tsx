        ...
        <div className="p-8">
          ...
          <div className="mb-8 bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h5 className="font-semibold text-orange-800 mb-2">Consejo de Vocabulario</h5>
                <p className="text-orange-700 text-sm">
                  Haz clic en cada palabra para ver su pronunciación, definición y ejemplo. 
                  Trata de usar estas palabras en tus propias oraciones.
                </p>
              </div>
            </div>
          </div>
